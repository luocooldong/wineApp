...
! function(t, e) {
	...
	function d(t, e, n) {
		if(t && e)
			if(t.forEach && t.forEach === Tp) t.forEach(e, n);
	...
	function Bt(t, e, n) {
		...
		if(i !== r)
			if(i > r) t.length = r;
				...
				for(a = i; a < r; a++) t.push(1 === n ? e[a] : fg.call(e[a]));
	...
	function Ft(t, e, n, i, r, o, a, s, l) {
		var u = t.length;
		if(1 == l)
			for(c = 0; c < u; c++) s[c] = Ht(t[c], e[c], n[c], i[c], r, o, a);
		else
			for(var h = t[0].length, c = 0; c < u; c++)
				for(var d = 0; d < h; d++) s[c][d] = Ht(t[c][d], e[c][d], n[c][d], i[c][d], r, o, a)
	}
			...
			if(o || !x) {
				...
				var O = new ft({
					...
					onframe: function(t, e) {
						...
						if(0 !== i)
							if(I = (e - m[n]) / i, l)
								if(T = v[n], C = v[0 === n ? n : n - 1], D = v[n > u - 2 ? u - 1 : n + 1], A = v[n > u - 3 ? u - 1 : n + 2], d) Ft(C, T, D, A, I, I * I, I * I * I, a(t, r), g);
								else {
									if(f) o = Ft(C, T, D, A, I, I * I, I * I * I, L, 1), o = Wt(L);
									else {
	...
	function de(t, e, n, i, r, o) {
		...
		r && (s += r[1] + r[3]);
		var l = a.outerHeight,
			u = new Xt(pe(0, s, n), ge(0, l, i), s, l);
	...
	function Me(t, e, n, i) {
		...
		if(n && (s += n[0] + n[2]), t && i) {
			...
			if(null != l && s > l) t = "", o = [];
				...
				for(var h = ye(u - (n ? n[1] + n[3] : 0), e, i.ellipsis, {
						minChar: i.minChar,
		...
		for(k = 0; k < a.length; k++) {
			for(var p = a[k], g = 0, m = 0, v = 0; v < p.tokens.length; v++) {
				var y = (P = p.tokens[v]).styleName && e.rich[P.styleName] || {},
					...
					w = P.textHeight = T(y.textHeight, we(_));
				...
				var b = y.textWidth,
					M = null == b || "auto" === b;
				if("string" == typeof b && "%" === b.charAt(b.length - 1)) P.percentWidth = b, u.push(P), b = 0;
				else {
					if(M) {
						b = P.textWidth;
					...
					null != A && A < b && (!M || A < C ? (P.text = "", P.textWidth = b = 0) : (P.text = ve(P.text, A - C, _, c.ellipsis, {
						minChar: c.minChar
					}), P.textWidth = he(P.text, _), b = P.textWidth + C))
				}
	...
	function Sn(t) {
		...
		gm(t, function(t, n) {
			...
			var i = t.exist,
				...
				o = t.keyInfo;
			if(mm(r)) {
				if(o.name = null != r.name ? r.name + "" : i ? i.name : ym + n, i) o.id = i.id;
	...
	function Zn(t, e, n, i, r, o) {
		var a = i + 3 * (e - n) - t,
			...
			d = l * l - 3 * s * u,
			f = 0;
		if(Fn(h) && Fn(c)) Fn(s) ? o[0] = 0 : (S = -l / s) >= 0 && S <= 1 && (o[f++] = S);
		else {
			var p = c * c - 4 * h * d;
			if(Fn(p)) {
				var g = c / h,
				...
				var _ = (2 * h * s - 3 * a * c) / (2 * km(h * h * h)),
					w = Math.acos(_) / 3,
					b = km(h),
					M = Math.cos(w),
					S = (-s - 2 * b * M) / (3 * a),
					m = (-s + b * (M + Om * Math.sin(w))) / (3 * a),
	...
	function _i(t, e, n, i, r, o, a, s, l, u, h) {
		var c = l * (Cv / 180),
			d = Iv(c) * (t - n) / 2 + Sv(c) * (e - i) / 2,
			f = -1 * Sv(c) * (t - n) / 2 + Iv(c) * (e - i) / 2,
			p = d * d / (a * a) + f * f / (s * s);
		p > 1 && (a *= Mv(p), s *= Mv(p));
		var g = (r === o ? -1 : 1) * Mv((a * a * (s * s) - a * a * (f * f) - s * s * (d * d)) / (a * a * (f * f) + s * s * (d * d))) || 0,
			m = g * a * f / s,
			v = g * -s * d / a,
			y = (t + n) / 2 + Iv(c) * m - Sv(c) * v,
			x = (e + i) / 2 + Sv(c) * m + Iv(c) * v,
			_ = Av([1, 0], [(d - m) / a, (f - v) / s]),
			w = [(d - m) / a, (f - v) / s],
			b = [(-1 * d - m) / a, (-1 * f - v) / s],
			M = Av(w, b);
	...
	function Wr(t, e, n, i, r) {
		...
		if(o || s) {
			var u;
			if("raw" === l) u = "group" === t.type ? new Xt(0, 0, +e.width || 0, +e.height || 0) : t.getBoundingRect();
	...
	function eo(t, e, n, i, r) {
		...
		if(e === Ly) "auto" === i || null == i ? io(function(t) {
			...
			r[e] = null != t ? t : ""
		}, n, t)), o = r ? r.length : n === By ? t.length : t[0] ? t[0].length : null;
		else if(e === Oy) r || (r = ro(t), s = !0);
		else if(e === zy) r || (r = [], s = !0, d(t, function(t, e) {
			r.push(e)
		}));
		else if(e === Py) {
			var l = wn(t[0]);
	...
	function lo(t, e, n, i, r, o) {
		...
		if(M(t)) return !1;
		var l;
		if(i && (l = w(l = i[o]) ? l.name : l), e === Ly)
			if(n === By) {
				for(var u = t[o], h = 0; h < (u || []).length && h < 5; h++)
					if(null != (s = a(u[r + h]))) return s
			} else
				for(h = 0; h < t.length && h < 5; h++) {
					...
					if(!l) return;
					for(h = 0; h < t.length && h < 5; h++)
						if((d = t[h]) && null != (s = a(d[l]))) return s
				} else if(e === zy) {
			if(!l) return;
			if(!(u = t[l]) || M(u)) return !1;
			for(h = 0; h < u.length && h < 5; h++)
				if(null != (s = a(u[h]))) return s
		} else if(e === Py)
			for(h = 0; h < t.length && h < 5; h++) {
				var d = t[h],
					f = wn(d);
	...
	function co(t) {
		t = t, this.option = {}, this.option[Fy] = 1, this._componentsMap = N({
			series: []
		}), this._seriesIndices, this._seriesIndicesMap, ho(t, this._theme.option), i(t, Ty, !1), this.mergeOption(t)
	}
	...
	function Ss(t, e) {
		var n = t.dimensions,
			i = new M_(f(n, t.getDimensionInfo, t), t.hostModel);
		vs(i, t);
	...
	function Zs(t, e, n, i) {
		...
		if(!t) return r;
		e[0] < n[0] && r.push(e[0]);
		for(var o = n[0]; o <= n[1] && (r.push(o), (o = k_(o + t, i)) !== r[r.length - 1]);)
	...
	function Ys(t) {
		...
		return d(t, function(t) {
			var n = t.getData(),
				...
				a = _r(t.get("barWidth"), o),
				s = _r(t.get("barMaxWidth"), o),
				l = t.get("barGap"),
	...
	function ll(t) {
		...
		if(e.get("axisLabel.show") && !n.isBlank()) {
			...
			for(var c = 0; c < r; c += h) {
				var d = u(i ? i[c] : a[0] + c),
					f = ul(l.getTextRect(d), l.get("rotate") || 0);
				s ? s.union(f) : s = f
			}
			return s
		}
	...
	function gl(t) {
		...
		for(var n = t.features, i = 0; i < n.length; i++)
			for(var r = n[i].geometry, o = r.coordinates, a = r.encodeOffsets, s = 0; s < o.length; s++) {
				var l = o[s];
				if("Polygon" === r.type) o[s] = ml(l, a[s], e);
	...
	function wl(t, e) {
		...
		if(r) return r;
		var o, a;
		if(e.get("show") && !t.scale.isBlank() || (o = []), x(i)) o = kl(t, i, !0);
		else if("auto" === i) {
	...
	function ql(t, e, n, i, r, o, a, s, l, u, h) {
		for(var c = 0, d = n, f = 0; f < i; f++) {
			...
			if(d === n) t[o > 0 ? "moveTo" : "lineTo"](p[0], p[1]), Iw(Tw, p);
			else if(l > 0) {
				var g = d + o,
					m = e[g];
				if(h)
					for(; m && Xl(e[g]);) m = e[g += o];
				var v = .5,
					y = e[c];
				if(!(m = e[g]) || Xl(m)) Iw(Dw, p);
				else {
					Xl(m) && !h && (m = p), W(Cw, m, y);
					var x, _;
					if("x" === u || "y" === u) {
	...
	function eu(t, e, n, i) {
		...
		return e && (f.shape[a ? "width" : "height"] = 0, sr(f, {
			shape: {
				width: u,
				height: h
			}
	...
	function nu(t, e, n, i) {
		...
		return e && (l.shape.endAngle = -a[0] * s, sr(l, {
			shape: {
				endAngle: -a[1] * s
			}
		}, i)), l
	...
	function su(t, e) {
		...
		for(var r = e.count(), o = Math.max(1, Math.round(r / 5)), a = 0; a < r; a += o)
			if(1.5 * El.getSymbolSize(e, a)[t.isHorizontal() ? 1 : 0] > i) return !1;
		return !0
	}
	...
	function fu(t, e, n) {
		...
		var i, r = t[e],
			o = n.model,
			a = o.get("axisLine.onZero"),
			s = o.get("axisLine.onZeroAxisIndex");
		if(a)
			if(null == s) {
				for(var l in r)
					if(r.hasOwnProperty(l) && pu(r[l])) {
						i = r[l];
						break
					}
			} else pu(r[s]) && (i = r[s])
	...
	function Cu(t, e, n) {
		...
		if(C(n.axisLabelShow, e.get("axisLabel.show")) && !i.scale.isBlank()) {
			var r = e.getModel("axisLabel"),
				o = r.get("margin"),
				a = i.getViewLabels(),
				s = (C(n.labelRotate, r.get("rotate")) || 0) * Uw / 180,
				l = Yw(n.rotation, s, n.labelDirection),
				u = e.getCategories(!0),
				h = [],
				c = _u(e),
		...
		qw(n.getCoordinateSystems(), function(n) {
			function s(i, s, l) {
				...
				if(d && ("auto" !== d || i || Nu(c))) {
					...
					var f = (c = i ? Au(l, h, r, e, i, s) : c).get("snap"),
						p = Ru(l.model),
	...
	function eh(t, e, n, i) {
		var r = n.type,
			o = new(0, ty[r.charAt(0).toUpperCase() + r.slice(1)])(n);
	...
	function ph(t, e, n) {
		var i = n.getZr(),
			r = wb(i).axisPointerLastHighlights || {},
			o = wb(i).axisPointerLastHighlights = {};
		xb(t, function(t, e) {
	...
	function lc(t, e, n, i, r, o) {
		var a = [],
			s = Ps(e, i) ? e.getCalculationInfo("stackResultDimension") : i,
			l = pc(e, s, t),
	...
	function uc(t, e) {
		...
		if(e && !sc(e) && !y(e.coord) && r) {
			...
			if((e = n(e)).type && Qb[e.type] && a.baseAxis && a.valueAxis) {
				var s = $b(o, a.baseAxis.dim),
					l = $b(o, a.valueAxis.dim);
	...
	function af(t, e, n, i, r, o, a, s) {
		...
		XM(r.split(""), function(t) {
			var e = eS[t];
			u[e[0]][e[1]] += h[e[0]]
		}), l.range = e(nf(u[0][0], u[1][0], u[0][1], u[1][1])), Wd(n, i), Yd(n, {
			isEnd: !1
		})
	}
	...
	function hf(t) {
		var e = YM(t[0][0], t[1][0]),
			n = YM(t[0][1], t[1][1]);
		return {
			x: e,
			y: n,
			width: qM(t[0][0], t[1][0]) - e,
			height: qM(t[0][1], t[1][1]) - n
		}
	}
	...
	function pf(t, e, i, r) {
		...
		if(t._track.push(i.slice()), qd(t) || a) {
			...
			if(a) {
				...
				a.__brushOption.range = h.getCreatingRange(uf(t, a, t._track)), r && (Fd(t, a), h.updateCommon(t, a)), Hd(t, a), o = {
					isEnd: r
				}
			}
	...
	var xp = 2311,
		...
		wp = {},
		bp = wp = "object" == typeof wx && "function" == typeof wx.getSystemInfoSync ? {
			browser: {},
			os: {},
			node: !1,
			wxa: !0,
	...
	var Np = (Object.freeze || Object)({
		...
		Rp = "undefined" == typeof Float32Array ? Array : Float32Array,
		Bp = Z,
		Vp = U,
		Fp = Y,
		Hp = q,
	...
	var Yp = "undefined" == typeof Float32Array ? Array : Float32Array,
		...
		applyTransform: function() {
			...
			return function(r) {
				if(r) {
					...
					var o = Mg(t[0], e[0], n[0], i[0]),
						a = Mg(t[1], e[1], n[1], i[1]);
	...
	Kg.prototype = {
		...
		insertLayer: function(t, e) {
			var n = this._layers,
				...
				a = -1,
				s = this._domRoot;
			if(n[t]) yg("ZLevel " + t + " has been used already");
			else if(qe(e)) {
				if(r > 0 && t > i[0]) {
	...
	var Qg = "undefined" != typeof window && !!window.addEventListener,
		Jg = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
		tm = Qg ? function(t) {
		...
		em = function(t) {
			t = t || {}, this.stage = t.stage || {}, this.onframe = t.onframe || function() {}, this._clips = [], this._running = !1, this._time, this._pausedTime, this._pauseStart, this._paused = !1, Zp.call(this)
		};
	em.prototype = {
		constructor: em,
		addClip: function(t) {
	...
	var hm = !bp.canvasSupported,
		...
		fm = function(t, e, n) {
			...
			this.handler = new jp(r, a, s, a.root), this.animation = new em({
				stage: {
	...
	var pm = (Object.freeze || Object)({
		...
		_m = 0,
		wm = ".",
		bm = "___EC__COMPONENT__CONTAINER___",
		Mm = 0,
		Sm = function(t) {
		...
		iv = Math.sqrt,
		rv = Math.abs,
		ov = "undefined" != typeof Float32Array,
		av = function(t) {
	...
	var sv = 2 * Math.PI,
		...
		dv = [-1, -1, -1],
		fv = [-1, -1],
		pv = Eg.prototype.getCanvasPattern,
		gv = Math.abs,
		mv = new av(!0);
	xi.prototype = {
		constructor: xi,
			...
			for(r = 0, o = 0; r < l.length;) {
				switch(n = l[r++], o = r, i = 0, n) {
					...
					case f:
						var g = e[4],
							m = e[5],
							v = xv(e[0] * e[0] + e[1] * e[1]),
							y = xv(e[2] * e[2] + e[3] * e[3]),
							x = _v(-e[1] / y, e[0] / v);
		...
		Ov = function(t) {
			return bp.browser.ie && bp.browser.version >= 11 ? function() {
				...
				if(t.apply(this, arguments), e)
					for(var l = 0; l < Lv.length; l++) i[Lv[l][0]] = Lv[l][2]
			} : t
		},
		zv = xi.extend({
			type: "sector",
	...
	Yv.prototype = {
		constructor: Yv
	}, u(Yv, Xv), Di.prototype.incremental = !0, Di.prototype.clearDisplaybles = function() {
	...
	var sy = 0,
		...
		xy = d,
		_y = ["left", "right", "top", "bottom", "width", "height"],
		wy = [
			["width", "left", "right"],
			["height", "top", "bottom"]
		],
	...
	lx.perform = function(t) {
		...
		if(this._dueEnd = n ? n._outputDueEnd : this._count ? this._count(this.context) : 1 / 0, this._progress) {
			...
			if(!i && (h || d < f)) {
				...
				if(y(p))
					for(var g = 0; g < p.length; g++) Yo(this, p[g], d, f, l, u);
				else Yo(this, p, d, f, l, u)
			}
			this._dueIndex = f;
	...
	var hx = Dn(),
		cx = Iy.extend({
			...
			getColorFromPalette: function(t, e, n) {
				var i = this.ecModel,
					r = Ay.getColorFromPalette.call(this, t, e, n);
	...
	var fx = dx.prototype;
	fx.updateView = fx.updateLayout = fx.updateVisual = function(t, e, n, i) {}, En(dx), Vn(dx, {
		registerWhenExtend: !0
	});
	var px = function() {
			var t = Dn();
	...
	vx.updateView = vx.updateLayout = vx.updateVisual = function(t, e, n, i) {
		...
		registerWhenExtend: !0
	}), ra.markUpdateMethod = function(t, e) {
		gx(t).updateMethod = e
	};
	var yx = {
	...
	var Ox = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1", "#e7bcf3", "#9d96f5", "#8378EA", "#96BFFF"],
		zx = {
			...
			colorLayer: [
				...
				["#37A2DA", "#32C5E9", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#e7bcf3", "#8378EA", "#96BFFF"], Ox
			]
		},
	...
	$x._onframe = function() {
		...
		if(Fx(e) && (n = e.lazyUpdate, i = e.silent, e = e.notMerge), this[jx] = !0, !this._model || e) {
			var r = new xo(this._api),
				o = this._theme,
				a = this._model = new Hy(null, null, o, r);
			a.scheduler = this._scheduler, a.init(null, null, o, r)
		}
		this._model.setOption(t, n_), n ? (this[Yx] = {
			silent: i
		}, this[jx] = !1) : (Pa(this), Kx.update.call(this), this._zr.flush(), this[Yx] = !1, this[jx] = !1, Ea.call(this, i), Na.call(this, i))
	}, $x.setTheme = function() {
	...
	var Kx = {
		...
		update: function(t) {
			...
			if(e) {
				...
				if(bp.canvasSupported) i.setBackgroundColor(a);
				else {
					var s = St(a);
		...
		updateView: function(t) {
			var e = this._model;
			e && (ra.markUpdateMethod(t, "updateView"), Va(e), this._scheduler.performVisualTasks(e, t, {
				setDirty: !0
			}), Fa(this, this._model, this._api, t), Wa(e, this._api))
		},
	...
	$x.resize = function(t) {
		...
		Fx(e) || (e = {
			silent: !!e
		}), Jx[t.type] && this._model && (this[jx] ? this._pendingActions.push(t) : (za.call(this, t, e.silent), e.flush ? this._zr.flush(!0) : !1 !== e.flush && bp.browser.weChat && this._throttledZrFlush(), Ea.call(this, e.silent), Na.call(this, e.silent)))
	...
	var g_ = N(["tooltip", "label", "itemName", "itemId", "seriesName"]),
		m_ = w,
		v_ = "e\0\0",
		y_ = {
		...
		b_ = ["_extent", "_approximateExtent", "_rawExtent"],
		M_ = function(t, e) {
			t = t || ["x", "y"];
	...
	S_.type = "list", S_.hasItemOption = !0, S_.getDimension = function(t) {
		...
		if(!(t >= e)) {
			...
			for(var w = new Array(s), b = t; b < e; b++) {
				...
				for(var M = Math.floor(b / i), S = b % i, I = 0; I < s; I++) {
					var C = a[I],
						T = o[C][M],
						D = this._dimValueGetter(w, C, b, I);
					T[S] = D;
					var A = c[C];
		...
		if(t) {
			...
			for(var i = new(e = gs(this))(this.count()), r = 0; r < i.length; r++) i[r] = r;
		return i
	}, S_.get = function(t, e) {
				...
				if(!this._indices) {
					...
					if(1 === i) {
						for(var d = this._storage[e[0]], f = 0; f < this._chunkCount; f++)
							for(var p = d[f], g = Math.min(this._count - f * this._chunkSize, this._chunkSize), m = 0; m < g; m++)((w = p[m]) >= l && w <= u || isNaN(w)) && (o[a++] = c), c++;
						h = !0
					} else if(2 === i) {
	...
	Ns.prototype.parse = function(t) {
		...
		this._isBlank = t
	}, Ns.prototype.getLabel = null, En(Ns), Vn(Ns, {
		registerWhenExtend: !0
	}), Rs.createByAxisModel = function(t) {
		var e = t.option,
			n = e.data,
			i = n && f(n, Vs);
		return new Rs({
	...
	var O_ = "__ec_stack_",
		z_ = "undefined" != typeof Float32Array ? Float32Array : Array,
		E_ = {
			seriesType: "bar",
			plan: px(),
			reset: function(t) {
	...
	var rw = Ai({
		...
		ow = {
			isDimensionStacked: Ps,
			enableDataStack: ks,
			getStackedDimension: Ls
		},
	...
	pl.prototype = {
		...
		transformTo: function(t, e, n, i) {
			var r = this.getBoundingRect(),
				o = r.width / r.height;
			n ? i || (i = n / o) : n = o * i;
			for(var a = new Xt(t, e, n, i), s = r.calculateTransform(a), l = this.geometries, u = 0; u < l.length; u++)
				if("polygon" === l[u].type) {
	...
	var pw = El.prototype,
		gw = El.getSymbolSize = function(t, e) {
	...
	pw._createSymbol = function(t, e, n, i, r) {
		...
		o.attr({
			...
			culling: !0,
			scale: Nl(i)
		}), o.drift = Rl, this._symbolType = t, this.add(o)
		...
		} else(l = this.childAt(0)).silent = !1, ar(l, {
			scale: Nl(o)
		}, r, e);
		if(this._updateCommon(t, e, o, n), a) {
			...
			}), l.scale = [0, 0], u && (l.style.opacity = 0), sr(l, h, r, e)
		}
		this._seriesModel = r
	};
	var mw = ["itemStyle"],
		vw = ["emphasis", "itemStyle"],
		yw = ["label"],
		xw = ["emphasis", "label"];
	...
	_w.updateData = function(t, e) {
		...
		r || n.removeAll(), t.diff(r).add(function(i) {
			...
			var u = r.getItemGraphicEl(l),
				h = t.getItemLayout(s);
			Vl(t, h, s, e) ? (u ? (u.updateData(t, s, a), ar(u, {
				position: h
			}, i)) : (u = new o(t, s)).attr("position", h), n.add(u), t.setItemGraphicEl(s, u)) : n.remove(u)
		}).remove(function(t) {
		...
		kw = xi.extend({
			...
			buildPath: function(t, e) {
				var n = e.points,
					...
					o = n.length,
					a = e.smoothMonotone,
					s = $l(n, e.smoothConstraint),
					l = $l(i, e.smoothConstraint);
				if(e.connectNulls) {
					for(; o > 0 && Xl(n[o - 1]); o--);
					for(; r < o && Xl(n[r]); r++);
				}
	...
	ra.extend({
		...
		render: function(t, e, n) {
			...
			f && c.type === i.type && M === this._step ? (v && !p ? p = this._newPolygon(u, x, i, m) : p && !v && (g.remove(p), p = this._polygon = null), g.setClipPath(iu(i, !1, !1, t)), _ && d.updateData(o, {
				...
				t.stopAnimation(!0)
			}), Kl(this._stackedOnPoints, x) && Kl(this._points, u) || (m ? this._updateAnimation(o, x, i, n, M, y) : (M && (u = ru(u, i, M), x = ru(x, i, M)), f.setShape({
				points: u
			}), p && p.setShape({
				points: u,
				stackedOnPoints: x
		...
		_updateAnimation: function(t, e, n, i, r, o) {
			var a = this._polyline,
				s = this._polygon,
				l = t.hostModel,
				u = ww(this._data, t, this._stackedOnPoints, e, this._coordSys, n, this._valueOrigin, o),
				h = u.current,
				c = u.stackedOnCurrent,
				d = u.next,
				f = u.stackedOnNext;
			r && (h = ru(u.current, n, r), c = ru(u.stackedOnCurrent, n, r), d = ru(u.next, n, r), f = ru(u.stackedOnNext, n, r)), a.shape.__points = u.current, a.shape.points = h, ar(a, {
				shape: {
					points: d
				}
			}, l), s && (s.setShape({
	...
	Bw.categoryAxis = i({
		...
		min: "dataMin",
		max: "dataMax"
	}, Bw.valueAxis), Bw.logAxis = a({
		scale: !0,
		logBase: 10
	}, Bw.valueAxis);
	var Vw = ["value", "category", "time", "log"],
		Fw = function(t, e, n, o) {
			d(Vw, function(a) {
				e.extend({
					type: t + "Axis." + a,
		...
		function i(n) {
			return function(i, s) {
				if(cu(i, t, e)) {
					...
					var u = new Nw(n, rl(i), [0, 0], i.get("type"), l),
						h = "category" === u.type;
					...
					if("number" == typeof h && (h = [h, h]), null != l) {
						...
						d([{
							...
							if("none" !== l[n] && null != l[n]) {
								var i = cl(l[n], -c / 2, -f / 2, c, f, s.stroke, !0),
									o = e.r + e.offset,
	...
	var Jw = ["axisLine", "axisTickLabel", "axisName"],
		tb = ["splitArea", "splitLine"],
		eb = Kw.extend({
			type: "cartesianAxis",
			...
			_splitLine: function(t, e) {
				...
				if(!n.scale.isBlank()) {
					var i = t.getModel("splitLine"),
						...
						o = r.get("color");
					o = y(o) ? o : [o];
					for(var s = e.coordinateSystem.getRect(), l = n.isHorizontal(), u = 0, h = n.getTicksCoords({
							tickModel: i
		...
		_renderNormal: function(t, e, n) {
			...
			o.diff(a).add(function(e) {
				...
				if(o.hasValue(e)) {
					...
					l ? ar(l, {
						shape: c
					}, u, e) : l = ob[s.type](o, e, h, c, i, u, !0), o.setItemGraphicEl(e, l), r.add(l), Uu(l, o, e, h, c, t, i, "polar" === s.type)
				} else r.remove(l)
			}).remove(function(t) {
			...
			cartesian2d: function(t, e, n, i, r, a, s) {
				...
				if(a) {
					var u = l.shape,
						h = r ? "height" : "width",
						c = {};
					u[h] = 0, c[h] = i[h], ty[s ? "updateProps" : "initProps"](l, {
						shape: c
					}, a, e)
				}
				return l
			...
			polar: function(t, e, n, i, r, o, s) {
				...
				if(o) {
					var h = u.shape,
						c = r ? "r" : "endAngle",
						d = {};
					h[c] = r ? 0 : i.startAngle, d[c] = i[c], ty[s ? "updateProps" : "initProps"](u, {
						shape: d
					}, o, e)
				}
				return u
		...
		d(n, function(t) {
			...
			for(var d = e.mapDimension(h.dim), f = e.mapDimension(o.dim), p = Ps(e, d), g = h.isHorizontal(), m = Js(o, h, p), v = 0, y = e.count(); v < y; v++) {
				...
				if(!isNaN(x)) {
					...
					var M, S, I, C;
					if(g) M = b, S = (T = n.dataToPoint([x, _]))[1] + l, I = T[0] - m, C = u, Math.abs(I) < c && (I = (I < 0 ? -1 : 1) * c), p && (r[a][_][w] += I);
					else {
	...
	var lb = function(t, e, n) {
		...
		hb = ss({
			...
			getDataParams: function(t) {
				var e = this.getData(),
					n = hb.superCall(this, "getDataParams", t),
					i = [];
	...
	cb.updateData = function(t, e, n) {
		...
		var s = this.childAt(0),
			...
			h = t.getItemLayout(e),
			c = o({}, h);
		c.label = null, n ? (s.setShape(c), "scale" === l.getShallow("animationType") ? (s.shape.r = h.r0, sr(s, {
			shape: {
				r: h.r
			}
		}, l, e)) : (s.shape.endAngle = h.startAngle, ar(s, {
			shape: {
				endAngle: h.endAngle
			}
		}, l, e))) : ar(s, {
	...
	var db = function(t, e, n, i) {
			var r, o, a = t.getData(),
				...
				l = !1;
			a.each(function(n) {
				var i, u, h, c, d = a.getItemLayout(n),
					f = a.getItemModel(n),
					p = f.getModel("label"),
	...
	var Db = Ih.extend({
			makeElOption: function(t, e, n, i, r) {
				var o = n.axis,
					a = o.grid,
					s = i.get("type"),
					l = Vh(a, o).getOtherAxis(o).getGlobalExtent(),
			...
			updateHandleTransform: function(t, e, n, i) {
				var r = n.axis,
					...
					s = Vh(o, r).getOtherAxis(r).getGlobalExtent(),
					l = "x" === r.dim ? 0 : 1,
					u = t.position;
	...
	as({
		...
		_showTooltipContent: function(t, e, n, i, r, o, a, s) {
			if(this._ticket = "", t.get("showContent") && t.get("show")) {
				...
				a = a || t.get("position");
				var h = e;
				if(u && "string" == typeof u) h = Nr(u, n, !0);
		...
		Xb = Hb.extend({
			...
			layoutInner: function(t, e, n) {
				...
				if((v = {
					...
					y[s] = Math.max(n[s] - c[s] - m, 0), y[l] = v[l], r.setClipPath(new Fv({
						shape: y
					})), r.__rectSize = y[s]
	...
	var tM = Hv.prototype,
		...
		nM = Ai({
			...
			tangentAt: function(t) {
				var e = this.shape,
					n = vc(e) ? [e.x2 - e.x1, e.y2 - e.y1] : eM.tangentAt.call(this, t);
				return j(n, n)
			}
		}),
		iM = ["fromSymbol", "toSymbol"],
		rM = bc.prototype;
	rM.beforeUpdate = function() {
		...
		var _ = m ? g : null,
			w = v ? T(i.getFormattedLabel(e, "emphasis", t.dataType), g) : null,
			b = y.style;
		null == _ && null == w || (Ki(y.style, l, {
			text: _
		}, {
			autoColor: p
	...
	var aM = function(t, e, r, a) {
		...
		if(!y(a) && ("min" === l || "max" === l || "average" === l || "median" === l || null != a.xAxis || null != a.yAxis)) {
			var u, h;
			if(null != a.yAxis || null != a.xAxis) u = null != a.yAxis ? "y" : "x", e.getAxis(u), h = C(a.yAxis, a.xAxis);
			else {
				var c = hc(a, s, e, t);
	...
	var uM = ["cartesian2d", "polar", "singleAxis"],
		hM = function(t, e) {
	...
	var pM = d,
		...
		mM = os({
			...
			doInit: function(t) {
				var e = this.option;
				bp.canvasSupported || (e.realtime = !1), this._setDefaultThrottle(t), Xc(this, t), pM([
					["start", "startValue"],
					["end", "endValue"]
				], function(t, n) {
		...
		SM = "horizontal",
		IM = 5,
		CM = ["line", "bar", "candlestick", "scatter"],
		TM = vM.extend({
			type: "dataZoom.slider",
			init: function(t, e) {
			...
			_updateInterval: function(t, e) {
				...
				var s = this._range,
					l = this._range = wM([_M(i[0], r, a, !0), _M(i[1], r, a, !0)]);
			...
			_updateDataInfo: function(t) {
				function e(t) {
					var e = lr(i.handles[t].parent, this.group),
						n = hr(0 === t ? "right" : "left", e),
						s = this._handleWidth / 2 + IM,
						l = ur([c[t] + (0 === t ? -s : s), this._size[1] / 2], e);
					r[t].setStyle({
						x: l[0],
						y: l[1],
			...
			_onDragMove: function(t, e, n) {
				this._dragging = !0;
				var i = ur([e, n], this._displayables.barGroup.getLocalTransform(), !0),
	...
	Md.defaultOption = {
		...
		if(r.href = a, "function" != typeof MouseEvent || bp.browser.ie || bp.browser.edge)
	...
	var HM = Sx.toolbox.dataView,
		GM = new Array(60).join("-"),
		WM = "\t",
		ZM = new RegExp("[" + WM + "]+", "g");
	zd.defaultOption = {
		show: !0,
	...
	var oS = {
			mousedown: function(t) {
				if(this._dragging) mf.call(this, t);
		...
		uS = l,
		hS = v,
		cS = ["dataToPoint", "pointToData"],
		dS = ["grid", "xAxis", "yAxis", "geo", "graph", "polar", "radiusAxis", "angleAxis", "bmap"],
		fS = Mf.prototype;
	fS.setOutputRanges = function(t, e) {
		this.matchOutputRanges(t, e, function(t, e, n) {
			if((t.coordRanges || (t.coordRanges = [])).push(e), !t.coordRange) {
				...
				t.__rangeOffset = {
					offset: yS[t.brushType](i.values, t.range, [1, 1]),
					xyMinMax: i.xyMinMax
				}
			}
		})
		...
		lS(t, function(t) {
			...
			if(t.range = t.range || [], n && !0 !== n) {
				t.panelId = n.panelId;
				var i = vS[t.brushType](0, n.coordSys, t.coordRange),
					r = t.__rangeOffset;
		...
		for(var n = this._targetInfoList, i = If(e, t), r = 0; r < n.length; r++) {
			...
			if(a) {
				...
				for(r = 0; r < gS.length; r++)
					if(gS[r](i, o)) return o
		}
		return !0
	};
	var pS = {
		...
		vS = {
			...
			lineY: hS(Cf, 1),
			rect: function(t, e, n) {
				var i = e[cS[t]]([n[0][0], n[1][0]]),
					r = e[cS[t]]([n[0][1], n[1][1]]),
	...
	var wS = Sx.toolbox.dataZoom,
		bS = d,
		MS = "\0_ec_\0toolbox-dataZoom_";
	Ef.defaultOption = {
		show: !0,
		icon: {
	...
	SS._onBrush = function(t, e) {
		...
		if(e.isEnd && t.length) {
			var r = {},
				o = this.ecModel;
			this._brushController.updateCovers([]), new Mf(Nf(this.model.option), o, {
				include: ["grid"]
	...
	var TS, DS = "urn:schemas-microsoft-com:vml",
		AS = "undefined" == typeof window ? null : window,
		kS = !1,
		PS = AS && AS.document;
	...
	if(!bp.canvasSupported) {
		...
		je.prototype.brushVML = function(t) {
			...
			if(r) {
				...
				if(this.transform && (x = this.transform, b = zS(x[0] * x[0] + x[1] * x[1]), M = zS(x[2] * x[2] + x[3] * x[3]), w = x[1] || x[2]), w) {
					...
					var D = BS(S[0], I[0], C[0], T[0]),
						A = BS(S[1], I[1], C[1], T[1]),
						k = [];
				...
				var O = P.style;
				if(v) {
					if(e && n) O.width = OS(b * e * c / f) + "px", O.height = OS(M * n * d / p) + "px";
					else {
						var z = new Image,
							E = this;
						z.onload = function() {
		...
		! function(t, e) {
			...
			return nI.innerHTML = "", nI.appendChild(n.createTextNode(t)), {
				width: nI.offsetWidth
			}
		});
		for(var sI = new Xt, lI = [Yg, Xe, je, xi, kv], uI = 0; uI < lI.length; uI++) {
			...
			hI.drawRectText = function(t, e, n, i) {
				...
				if(null != o && (o += ""), o) {
					...
					if(v && !i && (sI.copy(e), sI.applyTransform(v), e = sI), i) c = e.x, d = e.y;
					else {
						var y = r.textPosition,
							x = r.textDistance;
						if(y instanceof Array) c = e.x + jS(y[0], e.width), d = e.y + jS(y[1], e.height), f = f || "left";
						else {
							var _ = me(y, e, x);
		...
		CI = function(t, e, n) {
			...
			if(null != r) {
				...
				var c = i.font || [i.fontStyle || "", i.fontWeight || "", i.fontSize || "", i.fontFamily || ""].join(" ") || Wg,
					d = ep(i.textVerticalAlign),
					f = (n = ce(r, c, h, d)).lineHeight;
				...
				var g = i.textPadding;
				if(Kf(o, "x", a), Kf(o, "y", s), Jf(o, i, !0), t instanceof kv || t.style.transformText) $f(o, t.transform);
				else {
					if(t.transform) II.copy(e), II.applyTransform(t.transform), e = II;
					else {
				...
				if("baseline" === d ? (M = -n.height + f, g && (M -= g[2])) : "middle" === d ? (M = (-n.height + f) / 2, g && (s += (g[0] - g[2]) / 2)) : g && (M += g[0]), t.__text !== r || t.__textFont !== c) {
					...
					for(var I = t.__tspanList.length, C = 0; C < I; ++C) {
